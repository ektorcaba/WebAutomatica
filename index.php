        ...
        <?php
            ...
            foreach(array_slice($content_amazon,0,$settings['num_results']) as $product){
                ...
                echo '<div class="entry">';
                    ...
                    echo '<div class="imgbox"><a href="'.$product['link'].'" rel="nofollow sponsored" target="_blank" class="plink"><img loading="lazy" src="'.cacheimg($product['image']).'" alt="'.($product['title']).'"></a></div>';
                ...
                echo '<p class="title"><a href="'.$product['link'].'" rel="nofollow sponsored" target="_blank" class="plink">'.(($product['title'])).'</a></p>';

                if(!empty($product['price'])){
                    echo '<div class="onbottom"><a href="'.$product['link'].'" rel="nofollow sponsored" target="_blank">'.$product['price'].'</a></div></div>';
